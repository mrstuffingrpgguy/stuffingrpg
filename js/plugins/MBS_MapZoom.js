...
//=============================================================================
//-----------------------------------------------------------------------------
// Especificaçoes do plugin (Nao Modifique!)
 ...
 *
 * @author Masked
 * @plugindesc Torna possível que voce de zoom no mapa durante o jogo.
 * 
 * <MBS MapZoom>
 * @help
 * ===========================================================================
 ...
 * Note que o "y" é opcional, e se nao for definido o script assumirá que seu 
 * valor é igual a X. Se voce quiser, adicione um parâmetro 'duration' seguido
 * pelo número de frames que a operaçao deve levar, se a duraçao nao for 
 ...
 * MapZoom set 2.0 1.5 duration 20
 *
 * Se voce quiser, pode centralizar a câmera do zoom em um evento ou 
 ...
 * MapZoom reset [d]
 *
 * Se quiser, troque o '[d]' pelo número de frames que quiser que a operaçao
 * dure.
 *
 * Exemplos:
 * MapZoom reset 30
